...
function CheckLevel()
	...
	if Three_World then
		...
		elseif Lv >= 2150 and Lv <= 2224 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then -- Ice Cream Commander
...
spawn(function()
    while wait(2) do
        ...
        if _G.Electric_Claw and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
            ...
            if Three_World and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 then
                local FG = game:GetService("Players").LocalPlayer.Data.Fragments.Value
                if FG < 5000 and _G.Hop then
                    if Auto_Farm then
                        Auto_Farm = false
            ...
            if Three_World and game.Players.LocalPlayer.Character:FindFirstChild("Electro") and game.Players.LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400 then
                local FG = game:GetService("Players").LocalPlayer.Data.Fragments.Value
                if FG < 5000 and _G.Hop then
                    if Auto_Farm then
                        Auto_Farm = false
...
local New = serv:Channel("New! UPDATE 17")
                                                ...
                                                if v.Name == "rip_indra [Lv. 1500] [Boss]" then
                                                    repeat game:GetService("RunService").Heartbeat:wait()
                                                        ...
                                                        pcall(function()
                                                            ...
                                                            TP2(v.HumanoidRootPart.CFrame * CFrame.new(0,25,25))
                                            ...
                                            if v.Name == "Swan Pirate [Lv. 775]" then
                                                ...
                                                pcall(function()
                                                    repeat wait()
                                                        ...
                                                        TP2( v.HumanoidRootPart.CFrame * CFrame.new(0,15,0))
                                                        game:GetService'VirtualUser':CaptureController()
                                                        game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))                           
        ...
        if BuddySword then
            if game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen [Lv. 2175] [Boss]") or game.ReplicatedStorage:FindFirstChild("Cake Queen [Lv. 2175] [Boss]") then
                repeat game:GetService("RunService").Stepped:wait()
                    ...
                    game:GetService'VirtualUser':CaptureController()
                    game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                until game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen [Lv. 2175] [Boss]").Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen [Lv. 2175] [Boss]") or BuddySword == false
            else
                wait(2)
                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-821, 66, -10965)).Magnitude > 10 then
                    repeat wait(1)
                        TP2(CFrame.new(-821, 66, -10965))
                    until (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-821, 66, -10965)).Magnitude < 10
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
                end
                wait(5)
